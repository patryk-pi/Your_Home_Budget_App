...
const SignIn = () => {
    ...
    return (
        ...
        >
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    sx={{
                                        ...
                                        mb: 2,
                                        background:
                                            "linear-gradient(149deg, rgba(0,55,87,1) 0%, rgba(0,96,135,1) 46%, rgba(0,157,189,1) 86%)",
                                        fontFamily: "Open Sans",
                                    }}
                                >
                                    Zaloguj
            ...
            <SnackbarInfo
                severity={"error"}
                openState={openWrongMail}
                setOpenState={setOpenWrongMail}
                message={"Podany adres email jest nieprawidłowy."}
            />
            <SnackbarInfo
                severity={"error"}
                openState={openNoMail}
                setOpenState={setOpenNoMail}
                message={"Podaj adres email."}
            />
            <SnackbarInfo
                severity={"error"}
                openState={openWrongPassword}
                setOpenState={setOpenWrongPassword}
                message={"Nieprawidłowe hasło."}
            />
            <SnackbarInfo
                severity={"success"}
                openState={openSentPassword}
                setOpenState={setOpenSentPassword}
                message={"Wysłano linka do resetowania hasła."}
            />
        </Box>
    );
};
